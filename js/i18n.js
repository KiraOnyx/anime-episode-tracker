(function () {
  ...
  const translations = {
    fr: {
      ...
      preview_note: "Remplace ces cadres par tes captures via <code>js/media-manifest.js</code>.",
    ...
    en: {
      ...
      preview_note: "Replace these placeholders with your screenshots via <code>js/media-manifest.js</code>.",
