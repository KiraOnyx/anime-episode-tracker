(function () {
  ...
  const translations = {
    fr: {
      ...
      index_meta_title: "Anime Episode Tracker — Extension Chrome",
      ...
      provider_voiranime_desc: "Une fois sur la page d’un épisode, un bouton “Suivre” vous permet de l’ajouter directement dans l’extension. Le badge <span class=\"badgeN\">+N</span> indique les épisodes restants.",
      ...
      provider_animesama_desc: "L’intégration AnimeSama arrive : notifications VF/VOSTFR/VA et sauvegarde de votre progression sont en cours de finalisation.",
      ...
      preview_title: "Aperçus",
      preview_note: "Remplace ces cadres par tes captures via <code>js/config.js</code>.",
      footer_install: "Installer",
      footer_feedback: "Signaler un bug",
      footer_note: "Anime Episode Tracker — Non affilié à VoirAnime/MAL",
      privacy_meta_title: "Confidentialité — Anime Episode Tracker",
      privacy_meta_description: "Aucune télémétrie. Données en local. Permissions minimales.",
      privacy_title: "Confidentialité",
      privacy_intro: "Une politique simple et lisible : nous ne collectons rien, vos données restent chez vous et vous gardez la main en permanence.",
      ...
      privacy_contact_title: "Besoin d’un complément ?",
      privacy_contact_desc: "Vous avez repéré un comportement suspect ou vous souhaitez un audit plus détaillé ? Contactez-nous directement.",
      privacy_contact_cta: "Formulaire",
      privacy_contact_mail: "contact@anime-episode-tracker.app",
    ...
    en: {
      ...
      index_meta_title: "Anime Episode Tracker — Chrome Extension",
      ...
      provider_voiranime_desc: "Once you open an episode page, a “Follow” button lets you add it straight into the extension. The <span class=\"badgeN\">+N</span> badge shows what’s left to watch.",
      provider_voiranime_hint: "Click to open the VoirAnime preview.",
      provider_animesama_title: "AnimeSama",
      provider_status_soon: "In preparation",
      provider_animesama_desc: "AnimeSama support is on the way: VF/VOSTFR/VA notifications and full progress tracking are almost ready.",
      ...
      preview_note: "Replace these placeholders with your screenshots via <code>js/config.js</code>.",
      footer_install: "Install",
      footer_feedback: "Report a bug",
      footer_note: "Anime Episode Tracker — Not affiliated with VoirAnime/MAL",
      privacy_meta_title: "Privacy — Anime Episode Tracker",
      privacy_meta_description: "No telemetry. Local-only data. Minimal permissions.",
      privacy_title: "Privacy",
      privacy_intro: "A clear, professional policy: we collect nothing, your data stays with you, and you remain in control at all times.",
      ...
      privacy_contact_title: "Need more details?",
      privacy_contact_desc: "Spotted something unusual or need a deeper audit? Reach out directly.",
      privacy_contact_cta: "Feedback form",
      privacy_contact_mail: "contact@anime-episode-tracker.app",
      roadmap_meta_title: "Roadmap — Anime Episode Tracker",
