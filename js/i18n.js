(function () {
  ...
  const translations = {
    fr: {
      ...
      preview_label_popup: "Ouvrir l’aperçu de la fenêtre popup",
      preview_label_injection: "Ouvrir l’aperçu de l’injection VoirAnime",
      preview_label_settings: "Ouvrir l’aperçu des paramètres",
      preview_label_notification: "Ouvrir l’aperçu de la notification système",
    ...
    en: {
      ...
      preview_label_popup: "Open the popup preview",
      preview_label_injection: "Open the VoirAnime embed preview",
      preview_label_settings: "Open the settings preview",
      preview_label_notification: "Open the notification preview",
